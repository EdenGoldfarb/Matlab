...
fprintf(['test No. 4 top student #1 is in position %d in test1 scores\n', ...
    'test No. 4 top student #2 is in position %d in test1 scores\n', ...
    'test No. 4 top student #3 is in position %d in test1 scores\n'], ...
    ind_26, ind_28, ind_3)
